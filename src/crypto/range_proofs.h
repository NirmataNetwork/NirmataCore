...
namespace crypto
{
  ...
  ////////////////////////////////////////
  // crypto trait for Nirmata
  ////////////////////////////////////////
  struct bpp_crypto_trait_nirmata
  {
    ...
    {
      static scalar_t value = hash_helper_t::hs("Nirmata BP+ initial transcript");
      return value;
    }
    ...
    static const point_t& get_generator(bool select_H, size_t index)
    {
      ...
      if (!calculated)
      {
        scalar_t hash_buf[2] = { hash_helper_t::hs("Nirmata BP+ generator"), 0 };
