...
#define CURRENCY_PUBLIC_ADDRESS_BASE58_PREFIX           0x1882   // addresses start with 'Nn'
...
#define RPC_DEFAULT_PORT                                11113
#define STRATUM_DEFAULT_PORT                            11114
#define STRARUM_DEFAULT_PORT                            11115
...
#else
#define PREMINE_AMOUNT                                  ((uint64_t)0)
#endif
